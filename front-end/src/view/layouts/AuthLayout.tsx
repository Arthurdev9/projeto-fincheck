...
export function AuthLayout() {
  return (
    <div className="flex w-full h-full min-h-[520px] lg:min-h-[600px] bg-gray-0">
      ...
      <div className="hidden w-1/2 h-full lg:flex justify-center items-center p-8 relative">
        <img
          src={illustrationSrc}
          className="object-cover w-full h-full max-w-164 max-h-[960px] select-none rounded-[32px]"
